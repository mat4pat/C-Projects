// Very likely this isn't even close to an efficent way to create this project.
// The main difference between the first Tic-Tac-Toe, is that in this addition,
// is when you choose a previously chosen spot, it will tell you to repick.
// Hopefully this given you some insight into the statement of "goto", it proved very useful here.
...
void PlacesMarkPlayer1() { // Checks where Player 1 would put his mark.
	...
	RepeatForInput1 : //Reask the player for input once again if he chose previous chosen spots
	...
	switch(PickedNum) {	
		...
		case 1:
			if (Toe[PickedNum-1] == '1') {
				...
				goto RepeatForInput1;
			}
			break;
		case 2:
			if (Toe[PickedNum-1] == '2') {
				Toe[PickedNum-1]=Player1;
				break;
			}
			else {
...
void PlacesMarkPlayer2() { // Checks where Player 2 would put his mark.
	...
	RepeatForInput2 : // Reask the player for input once again if he chose previous chosen spots
